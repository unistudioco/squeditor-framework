...
?>
<!-- Site Footer -->
<footer id="sq_footer" class="sq-footer py-12 md:py-18 lg:py-24 border-t dark:bg-black/40">
  <div class="sq-footer-inner max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-8 lg:gap-12">
    <div class="sq--footer--brand md:col-span-2">
      ...
      <div class="flex gap-4">
        <?php foreach ($site['socials'] as $platform => $url): ?>
          <a href="<?= htmlspecialchars($url) ?>" class="hover:text-accent transition-colors">
    ...
    <div class="sq--footer--links">
      <h3 class="text-h6 mb-6">Product</h3>
      <ul class="space-y-4">
        <li><a href="#" class="hover:text-accent transition-colors">Editor</a></li>
        <li><a href="#" class="hover:text-accent transition-colors">Framework</a></li>
        <li><a href="#" class="hover:text-accent transition-colors">Templates</a></li>
        <li><a href="#" class="hover:text-accent transition-colors">Pricing</a></li>
      </ul>
    </div>

    <div class="sq--footer--links">
      <h3 class="text-h6 mb-6">Support</h3>
      <ul class="space-y-4">
        ...
        <li><a href="#" class="hover:text-accent transition-colors">Community</a></li>
        <li><a href="#" class="hover:text-accent transition-colors">FAQ</a></li>
      </ul>
    </div>
    
    <div class="sq--footer--links">
      <h3 class="text-h6 mb-6">Resources</h3>
      <ul class="space-y-4">
        ...
        <li><a href="#" class="hover:text-accent transition-colors">Freebies</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="sq-footer-bottom max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted">
    <p>&copy; <?= date('Y') ?> <?= htmlspecialchars($site['name']) ?>. Built with ❤️ using Squeditor Framework.</p>
